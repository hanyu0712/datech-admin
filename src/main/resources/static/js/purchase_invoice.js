...
$(document).ready(function() {
    ...
    $('#salesContractModal').on('show.bs.modal', function (event) {
        ...
        if ("insert" === method) {
            ...
            $.ajax({
                url: document.getElementById("serverUrl").value +'/purchaseInvoice/'+id,
                type: 'get',
                dataType: "json",
                success: function (data) {
                    ...
                    modal.find('#receiveDate').val(data.receiveDateStr);
                    modal.find('#invoiceAmount').val(data.invoiceAmount);
                    modal.find('#signer').val(data.signer);
    ...
    $('#salesContractModal').on('hide.bs.modal', function () {
        ...
        modal.find('#receiveDate').val("");
        modal.find('#invoiceAmount').val("");
        modal.find('#signer').val("");
        modal.find('#rejectionContent').val("");
...
{
    $.ajax({
        url: document.getElementById("serverUrl").value + "/updatePurchaseInvoice",
        type: 'post',
        dataType: "json",
        data: contract_data,
        success: function (data) {
